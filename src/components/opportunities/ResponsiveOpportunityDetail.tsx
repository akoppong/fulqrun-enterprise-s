...
export function ResponsiveOpportunityDetail({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[98vw] lg:max-w-[95vw] xl:max-w-[90vw] max-h-[98vh] w-[98vw] lg:w-[95vw] xl:w-[90vw] h-[98vh] p-0 gap-0 overflow-hidden">
        ...
        <div className="flex flex-col h-full bg-background">
          ...
          <div className="shrink-0 bg-gradient-to-r from-card/50 to-background border-b border-border px-4 py-3">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between">
                <Button 
                  ...
                  size="sm" 
                  onClick={onClose}
                  className="text-muted-foreground hover:text-foreground transition-colors h-9 px-3"
                ...
                <div className="flex items-center gap-2">
                  ...
                  {onDelete && (
                    <Button 
                      ...
                      variant="outline"
                      onClick={onDelete}
                      className="h-9 px-4 text-sm text-red-600 border-red-200 hover:bg-red-50"
                  ...
                  <TabsList className="h-12 bg-transparent w-full justify-start gap-0 p-0">
                    <ScrollArea className="w-full" orientation="horizontal">
                      <div className="flex gap-0 min-w-max">
                        <TabsTrigger 
                          value="overview" 
                          className="h-12 px-4 text-sm font-medium whitespace-nowrap data-[state=active]:bg-background data-[state=active]:shadow-sm border-r border-border/50 rounded-none data-[state=active]:border-b-2 data-[state=active]:border-b-primary"
                        >
                        ...
                        <TabsTrigger 
                          value="contact" 
                          className="h-12 px-4 text-sm font-medium whitespace-nowrap data-[state=active]:bg-background data-[state=active]:shadow-sm rounded-none data-[state=active]:border-b-2 data-[state=active]:border-b-primary"
                        >
